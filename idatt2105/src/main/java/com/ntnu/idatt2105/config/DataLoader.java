...
public class DataLoader implements ApplicationRunner{
    ...
    public void setUpReservations(){
        ...
        User user = users.get(0);
            ...
            Reservation reservation = new Reservation("12:15", "16:00", LocalDate.now().plusWeeks(1), room.getName(), user, sections1);
            Reservation reservation1 = new Reservation("08:15", "10:00", LocalDate.now().plusDays(12), room.getName(), user, sections1);
